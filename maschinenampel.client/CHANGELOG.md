...
- Create Angular project with ng: `ng new maschinenampel.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`maschinenampel.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `maschinenampel.client.esproj`).
